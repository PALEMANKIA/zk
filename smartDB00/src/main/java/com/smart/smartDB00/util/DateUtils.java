...
/**
 * Created by 99902020 on 2019/1/22.
 */


public class DateUtils {

    public static final String TDATE_TIME_PATTERN = "yyyy-MM-dd'T'HH:mm:ss";
...
//        Date date = DateUtils.dateParse("2020-06-12T08:50:28.391Z",TDATE_TIME_PATTERN);
//        System.out.println(dateFormat(date,DATE_TIME_PATTERN));

//        Date date = minDateOfMonth(new Date());
